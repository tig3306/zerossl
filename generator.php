...
$preparedOptions->targetSubfolder = InputSanitizer::getCliArgument("a", "targetSubfolder", $options, "ssl",InputType::STRING);
...
$preparedOptions->validationType = CertificateValidationType::tryFrom(InputSanitizer::getCliArgument("m", "validationMethod", $options, "HTTP_CSR_HASH",InputType::STRING));
